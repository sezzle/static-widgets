class SezzleCheckoutButton {
    constructor(options) {
        ...
        this.template =
            options.template && options.template.split(" ")[0] === "Pay"
                ? "Pay"
                : "Checkout";
        ...
        this.language = this.translationsMap[document.documentElement.lang]
            ? document.documentElement.lang
            : "en";
        this.translation = this.translationsMap[this.language];
    }
        ...
        sezzleButtonModal.innerHTML = `
                ...
                <div class="sezzle-checkout-modal-close">
                    <svg
                        ...
                        fill="none"
                    >
                        <g clip-path="url(#clip0_195_11536)">
                            <path
                    ...
                    <div class="sezzle-checkout-button-modal-body">
                        <div class="sezzle-checkout-step">
                            ...
                            <p class="sezzle-checkout-step-description">
                                ${this.translation.Modal.chooseSezzle}
                            </p>
                        </div>
                        <div class="sezzle-checkout-step">
                            <div alt="" class="sezzle-checkout-step-graphic">
                            ...
                            <p class="sezzle-checkout-step-description">
                                ${this.translation.Modal.selectPlan}
                            </p>
                        </div>
                        <div class="sezzle-checkout-step">
                            <div alt="" class="sezzle-checkout-step-graphic">
                            ...
                            <p class="sezzle-checkout-step-description">
                                ${this.translation.Modal.completeOrder}
                            </p>
                        </div>
                        <button class="sezzle-checkout-button-modal-button">
                            ${this.translation.Modal.continue}
                        </button>
                    </div>
                </div>
            </div>
    ...
    parseButtonTemplate() {
        ...
        const templateString = this.translation.Widget[this.template].replace(
            "%%logo%%",
    ...
    checkMinPrice(sezzleCheckoutButton) {
        ...
        if (this.cartTotal && this.cartTotal < minPrice) {
            const minPriceText = this.translation.Widget.minPrice(minPrice);
