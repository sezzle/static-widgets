...
class AwesomeSezzle {
  ...
  handleFeaturesAccordion(modalNode) {
    const toggleBtn = modalNode.querySelector(".accordion-toggle");
  ...
  buildModalHTML() {
    ...
    return `
        ...
        <div id="sezzle-modal-core-content" class="sezzle-modal-content">
                    <p class='trusted'>${this.translations.MultiPlantrusted}</p>
            <header class='sezzle-header'>${this.translations.MultiPlanheader}</header>
            <div class='payment-plan-wrapper'>
                <p class='sample-payments ${
                    this.language === "fr" ? "sezzle-multi-plan-fr" : ""
                }'>
                    <span class="sample-payments-title">${
                        this.translations.MultiPlanSeePlans
                    }</span>
                    <span class="input-amount-container">
                        <label class="input-amount-label" for="multi-plan-input-amount">${
                            this.translations.MultiPlanAmount
                        }</label>
                        <input class='price input-amount' id="multi-plan-input-amount" maxlength="9" value='${
                ...
                <div class='payment-cards payment-cards-biweekly' ${isPI4Eligible ? `style="display: block"` : `style="display: none"`}>
                    <div class='payment-card 4-pay-installment-card'>
                        <div class='plan-summary'>
                            <div class='purple'>
                                ...
                                <div class='right'>
                                    <span class='pill'>${
                                        this.translations.MultiPlanpayIn
                                    } 4</span>
                                </div>
                            </div>
                            <div class='grey'>
                    ...
                    <div class='payment-card 5-pay-installment-card'  ${isPI5Eligible ? `style="display: block"` : `style="display: none"`}>
                        <div class='plan-summary'>
                            <div class='purple'>
                                <div class='left'>
                    ...
                    <div class="payment-cards payment-cards-monthly"  ${isLTEligible ? `style="display: block"` : `style="display: none"`}>
                        <div class="payment-card monthly-installment-card" data-months="${terms[2]}" ${
                            ...
                            <div class="plan-summary">
                                <div class="purple">
                                    ...
                                    <div class="right">
                                        <span class="pill">${terms[2]} ${this.translations.LTtermLength}</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="payment-card monthly-installment-card" data-months="${terms[1]}"  ${
                            ...
                            <div class="plan-summary">
                                <div class="purple">
                                    ...
                                    <div class="right">
                                        <span class="pill">${terms[1]} ${this.translations.LTtermLength}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="plan-details monthly-plan-details">
                        ...
                        <div class="payment-card monthly-installment-card" data-months="${terms[0]}"  ${
                            ...
                            <div class="plan-summary">
                                <div class="purple">
                                    ...
                                    <div class="right">
                                        <span class="pill">${terms[0]} ${this.translations.LTtermLength}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="plan-details monthly-plan-details">
                        ...
                        <div class="features-accordion">
                            <div class="accordion-title-bar">
                                <span class="accordion-title" aria-hidden="true">${this.translations.LTseeDetails}</span>
                                <button class="accordion-icon accordion-toggle" aria-expanded="false" aria-controls="features-drawer" aria-label="${this.translations.LTseeDetails}" data-label-expand="${this.translations.LTseeDetails}" data-label-collapse="${this.translations.LThideDetails}">
                                    <svg class="accordion-icon-expand" width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.4625 0.2925L5.5825 4.1725L1.7025 0.2925C1.3125 -0.0975 0.6825 -0.0975 0.2925 0.2925C-0.0975 0.6825 -0.0975 1.3125 0.2925 1.7025L4.8825 6.2925C5.2725 6.6825 5.9025 6.6825 6.2925 6.2925L10.8825 1.7025C11.2725 1.3125 11.2725 0.6825 10.8825 0.2925C10.4925 -0.0875 9.8525 -0.0975 9.4625 0.2925Z" fill="#8333D4"></path>
                                    </svg>
                                    <svg class="accordion-icon-collapse" style="display:none" width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4.8825 0.2925L0.2925 4.8825C-0.0975 5.2725 -0.0975 5.9025 0.2925 6.2925C0.6825 6.6825 1.3125 6.6825 1.7025 6.2925L5.5925 2.4125L9.4725 6.2925C9.8625 6.6825 10.4925 6.6825 10.8825 6.2925C11.2725 5.9025 11.2725 5.2725 10.8825 4.8825L6.2925 0.2925C5.9125 -0.0975 5.2725 -0.0975 4.8825 0.2925Z" fill="#8333D4"></path>
                                    </svg>
                                </button>
                            </div>
                            <div id="features-drawer" class="features-drawer" style="display: none;">
                                ...
                                <div class="single-feature">
                                    ...
                                    <span>${this.translations.LTsingleFeaturePrequalify}</span>
                                </div>
                                <div class="single-feature">
                                    <div>
                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>${this.translations.LTsingleFeatureTrusted}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class='carousel-header'>
                    <div class='how-to-text-wrapper'>
                        <span class='how-to-text'>${
                            this.translations.MultiPlanhowToPay
                        }</span>
                    ...
                    <div class='arrows'>
                        <button type='button' class='arrow arrow-left disabled' aria-label='${this.translations.MultiPlanpreviousSlide}' aria-disabled='true'>
                        ...
                        <button class='arrow arrow-right' aria-label='${this.translations.MultiPlannextSlide}'>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class='carousel position-1'>
                    <div class='carousel-item'>
                        <div class='carousel-item-content'>
                            ...
                            <div class='step-name'>${this.translations.MultiPlanStep1}</div>
                    ...
                    <div class='carousel-item'>
                        <div class='carousel-item-content'>
                            ...
                            <div class='step-name'>${this.translations.MultiPlanStep2}</div>
                            <div class='step-image'>
                    ...
                    <div class='carousel-item'>
                        <div class='carousel-item-content'>
                            ...
                            <div class='step-name'>${this.translations.MultiPlanStep3}</div>
                            <div class='step-image'>
            ...
            <div class="terms-container">
                ...
                <p class="terms">
                    ...
                    } ${isPI5Eligible ? this.translations.webBankTermsPI5 : this.translations.webBankTermsPI4}</span>
                    <br />
