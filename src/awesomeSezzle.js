    ...
    if (!document.getElementsByClassName('sezzle-checkout-modal-lightbox').length) {
      ...
      if (this.altModalHTML) {
        ...
        if (this.language === "fr") {
          ...
          modalNode.innerHTML = `<meta name="viewport" content="width=device-width, initial-scale=1.0"><div class="sezzle-checkout-modal-hidden"> <div class="sezzle-modal"> <div class="sezzle-modal-content"> <div class="sezzle-logo"></div><div class="close-sezzle-modal"></div><div class="sezzle-header"> Jetzt Sezzlen. <span class="header-desktop">Sp&#228;ter zahlen.</span> <div class="header-mobile">Sp&#228;ter zahlen.</div></div><div class="sezzle-row"> <div class="desktop">Checke einfach mit Sezzle aus<br/> und zahle deine gesamte Bestellung in<div>4 zinslosen Raten &#252;ber 3 Monate.</div></div><div class="mobile"> Checke einfach mit Sezzle aus und zahle deine gesamte Bestellung in 4 zinslosen Raten &#252;ber 3 Monate.</div></div><!--<div class="sezzle-payment-pie-de"> </div> --> 		<div class="sezzle-hiw-pie-bg">
          <img class="sezzle-payment-pie-graph"
            src="https://media.sezzle.com/branding/2.0/merchant/howItWorks/payment-pie-graph.svg"
            alt="payment break down 25% heute, 25% Monat 1, 25% Monat 2, 25% Monat 3" />
